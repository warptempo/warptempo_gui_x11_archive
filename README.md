...
The REAPER mastering project is included, and uses FabFilter's Saturn 2, Pro-MB, Pro-C 2 and Pro-L 2 plugins, as well as Linux Studio Plugins' Clipper Stereo.
