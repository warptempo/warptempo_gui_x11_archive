...
The REAPER mastering project is included, and uses FabFilter's Saturn 2, Pro-MB, Pro-Q 4, Pro-R 2, Pro-C 2 and Pro-L 2 plugins, as well as REAPER's Event Horizon Clipper.
